...
void OurDisplay::add(Digit digit)
{
...
void OurDisplay::setDecimalSeparator()
{
	std::cout << ".";
}

//Sets the signal of the number to be displayed
void OurDisplay::setSignal(Signal signal)
{
	switch (signal)
	{
	case POSITIVE:
...
void OurDisplay::setError()
{
	std::cout << "Error" << std::endl;
}

//clears the display
void OurDisplay::clear()
{
	std::cout << "\n";
}